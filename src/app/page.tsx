...
export default function Home() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-black">
      <aside
        className={cn(
          'shrink-0 border-r border-gray-800 bg-gray-900/40 overflow-y-auto transition-all duration-300',
      ...
      <main className="flex-1 relative min-w-0">
        <button
          ...
          className="absolute top-4 left-4 z-10 p-2 rounded-lg bg-gray-900/60 border border-gray-700 text-gray-300 hover:bg-gray-800 hover:text-white transition-colors cursor-pointer"
